...
class InputGenre extends StatefulWidget {
  ...
  static String routeName = "/input_genre";
  @override
...
class _InputGenreState extends State<InputGenre> {
  ...
  TextEditingController namaGenreController = TextEditingController();
  @override
        ...
        appBar: AppBar(
          ...
          title: Row(
            children: [
              ...
              const Text('Input Genre', style: TextStyle(color: Colors.white)),
            ],
          ),
        ),
            ...
            child: Column(
              ...
              children: [
                ...
                isLoading
                    ...
                    : ElevatedButton(
                        onPressed: () {
                          if (namaGenreController.text.isEmpty &&
                              namaGenreController.text == '') {
                            toastification.show(
                                context: context,
                                title:
  ...
  void tambahkanResponse() async {
    try {
      ...
      Response response;
      response =
          await dio.post(insertGenre, data: {"name": namaGenreController.text});
