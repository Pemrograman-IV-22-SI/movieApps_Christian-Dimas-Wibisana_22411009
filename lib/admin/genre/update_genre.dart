...
class UpdateGenre extends StatefulWidget {
  ...
  static String routeName = "/update_genre";
  @override
...
class _UpdateGenreState extends State<UpdateGenre> {
  ...
  void updateGenreResponse(int id_genre, name) async {
    try {
      ...
      Response response;
      response =
          await dio.put(editGenre + id_genre.toString(), data: {"name": name});
